...
function Module() {
	...
	this.isfirst = true;    //최초 Cue로 부터 데이터를 받을 때 앞에 불필요한 stream 제거(header가 넘어 올때까지)
	this.isBuffering = 0;   //Cue로 부터 Random size로 받은 데이터 순차적으로 처리하기 위한 flag
	this.serialData_q = []; //Cue로 부터 받은 데이터 담는 배열
}
...
Module.prototype.getCueCommand = function (c, a, cnt, pa, pb, pc, pd) {
	...
	switch (c) {
		...
		case CueCategoryCmd.SOUND:
			buffer.push(0x18, 0x53, 0x4E);
			switch (a) {
				case CueActionCmd_Sound.SAY:
					switch (pa) {
						case CueParamCmd_Sound_Say.LAUGH: buffer.push(0x50, 0x45, 0x47, 0x49, 0x47, 0x47, 0x41, 0x4e, 0x4c, 0x41); break;
						case CueParamCmd_Sound_Say.SIGH: buffer.push(0x5a, 0x45, 0x53, 0x49, 0x47, 0x48, 0x32); break;
						case CueParamCmd_Sound_Say.WOOHOO: buffer.push(0x50, 0x45, 0x57, 0x4f, 0x4f, 0x48, 0x4f, 0x4f); break;
						case CueParamCmd_Sound_Say.OUCH: buffer.push(0x50, 0x45, 0x4f, 0x55, 0x43, 0x48); break;
						case CueParamCmd_Sound_Say.SCARED: buffer.push(0x50, 0x45, 0x41, 0x48, 0x48); break;
						case CueParamCmd_Sound_Say.MOVE: buffer.push(0x50, 0x45, 0x48, 0x45, 0x52, 0x45, 0x49, 0x47, 0x4f); break;
						case CueParamCmd_Sound_Say.START: buffer.push(0x50, 0x45, 0x4c, 0x45, 0x54, 0x53, 0x44, 0x4f, 0x54); break;
						case CueParamCmd_Sound_Say.SUCCESS: buffer.push(0x50, 0x45, 0x4d, 0x49, 0x53, 0x53, 0x44, 0x45, 0x41, 0x43); break;
						case CueParamCmd_Sound_Say.CLAP: buffer.push(0x50, 0x45, 0x4c, 0x45, 0x54, 0x53, 0x48, 0x45, 0x41); break;
						case CueParamCmd_Sound_Say.SENSOR: buffer.push(0x50, 0x45, 0x53, 0x45, 0x54, 0x54, 0x55, 0x50, 0x53, 0x45, 0x53); break;
						case CueParamCmd_Sound_Say.PICKUP: buffer.push(0x50, 0x45, 0x50, 0x49, 0x43, 0x4b, 0x4d, 0x45, 0x55, 0x50, 0x41); break;
						case CueParamCmd_Sound_Say.PUTDOWN: buffer.push(0x50, 0x45, 0x4f, 0x4b, 0x49, 0x4d, 0x52); break;
						case CueParamCmd_Sound_Say.HANDINFRONT: buffer.push(0x50, 0x45, 0x50, 0x55, 0x54, 0x59, 0x4f, 0x48, 0x41, 0x49); break;
						case CueParamCmd_Sound_Say.HANDBEHIND: buffer.push(0x50, 0x45, 0x50, 0x55, 0x54, 0x59, 0x4f, 0x48, 0x41, 0x42); break;
						case CueParamCmd_Sound_Say.FAIL: buffer.push(0x50, 0x45, 0x54, 0x49, 0x4d, 0x45, 0x46, 0x4f, 0x41, 0x4e); break;
						case CueParamCmd_Sound_Say.SONG: buffer.push(0x50, 0x45, 0x48, 0x45, 0x4c, 0x4c, 0x48, 0x45, 0x48, 0x45, 0x57); break;
						case CueParamCmd_Sound_Say.GOODBYE: buffer.push(0x50, 0x45, 0x53, 0x45, 0x45, 0x59, 0x4f, 0x4c, 0x41); break;
						case CueParamCmd_Sound_Say.HAPPYBIRTHDAY: buffer.push(0x50, 0x45, 0x48, 0x41, 0x50, 0x50, 0x42, 0x49); break;
						case CueParamCmd_Sound_Say.HAPPYHOLIDAY: buffer.push(0x50, 0x45, 0x48, 0x41, 0x50, 0x50, 0x48, 0x4f); break;
						case CueParamCmd_Sound_Say.CIRCLE: buffer.push(0x50, 0x45, 0x43, 0x49, 0x52, 0x43, 0x4c, 0x45); break;
						case CueParamCmd_Sound_Say.TRIANGLE: buffer.push(0x50, 0x45, 0x54, 0x52, 0x49, 0x41, 0x4e, 0x47, 0x4c, 0x45); break;
						case CueParamCmd_Sound_Say.SQUARE: buffer.push(0x50, 0x45, 0x53, 0x51, 0x55, 0x41, 0x52, 0x45); break;
						case CueParamCmd_Sound_Say.RED: buffer.push(0x50, 0x45, 0x52, 0x45, 0x44); break;
						case CueParamCmd_Sound_Say.ORNAGE: buffer.push(0x50, 0x45, 0x4f, 0x52, 0x41, 0x4e, 0x47, 0x45); break;
						case CueParamCmd_Sound_Say.YELLOW: buffer.push(0x50, 0x45, 0x59, 0x45, 0x4c, 0x4c, 0x4f, 0x57); break;
						case CueParamCmd_Sound_Say.GREEN: buffer.push(0x50, 0x45, 0x47, 0x52, 0x45, 0x45, 0x4e); break;
						case CueParamCmd_Sound_Say.BLUE: buffer.push(0x50, 0x45, 0x42, 0x4c, 0x55, 0x45); break;
						case CueParamCmd_Sound_Say.ONE: buffer.push(0x50, 0x45, 0x4f, 0x4e, 0x45); break;
						case CueParamCmd_Sound_Say.TWO: buffer.push(0x50, 0x45, 0x54, 0x57, 0x4f); break;
						case CueParamCmd_Sound_Say.THREE: buffer.push(0x50, 0x45, 0x54, 0x48, 0x52, 0x45, 0x45); break;
						case CueParamCmd_Sound_Say.FRONT: buffer.push(0x50, 0x45, 0x46, 0x52, 0x4f, 0x4e, 0x54); break;
						case CueParamCmd_Sound_Say.BACK: buffer.push(0x50, 0x45, 0x42, 0x41, 0x43, 0x4b); break;
						case CueParamCmd_Sound_Say.RIGHT: buffer.push(0x50, 0x45, 0x52, 0x49, 0x47, 0x48, 0x54, 0x33); break;
						case CueParamCmd_Sound_Say.LEFT: buffer.push(0x50, 0x45, 0x4c, 0x45, 0x46, 0x54); break;
					}
					break;
			}
			break;
...
Module.prototype.reset = function () {
	...
	isDraing = true;    //Cue로 데이터 보내기 전에 false로 변경 다 보내고 다시 true
	sendBuffers = [];  //Cue로 보내는 데이터 담은 배열
};
